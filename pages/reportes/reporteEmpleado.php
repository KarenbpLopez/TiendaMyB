...
<div id="reporte">
  ...
  <tr>
	  ...
	  <tr>
	    <th align="center" class="titulotabla">REPORTE DE EMPLEADOS</th><br>
      	    </tr>
...
include "conexion_db.php";
  ...
  $resultado=$db->query("SELECT * FROM t_empleado");
  if($resultado){
...
<?php
    while ($fila = $result->fetch_object()) {
        if ($contador % $numeroFilas == 0) {
            encabezado("");
            echo "<table border='1' class='formatocontenidotabla' cellspacing='7' cellpadding='0' rules='all'>";
        }
        $contador++;
        echo "<tr style='height:20px;''>";
        echo "<td width='40'   align='center'>" . $contador . "</td>";
        echo "<td width='200'  align='center'>" . $fila->c_dui . "</td>";
        echo "<td width='100'  align='center'>" . $fila->c_nombre . "</td>";
        echo "<td width='100'  align='center'>" . $fila->c_apellido . "</td>";
        echo "<td width='100'  align='center'>" . $fila->c_direccion . "</td>";
