  ...
  <link rel="icon" type="image/png" href="images/icons/favicon3.ico"/>
    ...
    <script type="text/javascript">
        function abrirVentana() {
              ...
              newWindow=window.open('reportes/reporteProveedor.php', 'Reporte','width=' + window_width + ',height=' + window_height + ',top=' + window_top + ',left=' + window_left + ',features=' + newfeatures + '');
}
 ...
 <body id="mimin" class="dashboard">
     ...
     <!--inicio decontent-->
      <div id="content">
                        ...
                        <div class="modal-dialog modal-md modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <input type="hidden" id="formHiddenIDProveedor">
                                  <div id="contenido">  
                                    ...
                                    <form id="registroCliente">
                                            ...
                                            <div class="row">
                                              <div class="col-md-8">
                                                <input type="text" class="form-control roundtext2" placeholder="Nombre" id="formNombreProveedor" autocomplete="off"
              ...
              <!--fin modal para registrar Proveedor-->
    ...
    <!-- custom -->
     ...
     <script src="asset/js/proveedores/app-proveedor.js"></script>
  <!-- end: Javascript -->
  </body>
</html>