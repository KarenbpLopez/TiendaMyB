     ...
     <!--inicio decontent-->
      <div id="content">
                                          ...
                                          <div class="col-md-6">
                                             <input type="text" class="form-control roundtext2" placeholder="Proveedor" style="width: 225px;display: inline;">
                                              ...
                                              <div class="col-md-6">
                                                         ...
                                                         <input type="text" class="form-control roundtext2" placeholder="Producto" style=" width: 225px;display: inline;">
                                                        <button style="width: 40px;display: inline" class="btn ripple-infinite btn-round btn-success"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                              ...
                                              <div class="col-md-6">
                                                ...
                                                <input type="date" class="form-control roundtext2" placeholder="Fecha de Vencimiento" style="width: 225px;display: inline;height: 35px">
                                                      ...
                                                      <input style="float: left;width: 228px;" type="button" value="Agregar" id="guardar"  name="guardar" class="btn ripple-infinite btn-round btn-success"  >
                    ...
                    <div class="panel-body">
                      ...
                      <thead>
                        <tr>
                           ...
                           <td width="170px">Fecha de Vencimiento</td>
                           <td>Cantidad</td>
                           <td>Precio</td>
                           <td>SubTotal</td>
                        </tr>
                      ...
                      <tbody>
                        <tr>
                          <td></td>
                             ...
                             <td width="25px"><button  type="button" class="form-control btn-warning roundtext" data-target="#modalModificar" data-toggle="modal" >
          ...
          X</button></td>
              ...
              <!--fin de tabla-->
              <label style="float: left;font-size: 32px;padding-left: 20px;top: 10px;">Total:</label>
              <input style="float: right;width: 130px;right: 20px;top: 10px;" type="button" value="Guardar" id="guardar"  name="guardar" class="btn ripple-infinite btn-round btn-success"  >
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                  ...
                                  <h3  style="padding-left:40%;padding-left:150px;color:#918c8c;"  id="myModalLabel">Detalles De Compra</h3>
          ...
          X</button></td>
              ...
              <!--fin de tabla-->
              <label style="float: left;font-size: 32px;padding-left: 20px;top: 10px;color:#918c8c;">Total:</label>
